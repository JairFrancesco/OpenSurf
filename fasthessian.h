...
class FastHessian {
  ...
  public:
    FastHessian(std::vector<Keypoint> &ipts, 
...
FastHessian::FastHessian(std::vector<Keypoint> &ipts, 
...
FastHessian::FastHessian(IplImage *img, std::vector<Keypoint> &ipts, 
                         const int octaves, const int intervals, const int init_sample, 
                         const float thresh) 
                         : ipts(ipts), i_width(0), i_height(0)
{
