...
int mainKmeans()
{
  IplImage *img = cvLoadImage("/Users/kylegoehner/payload/sift/images/ISSAC_0619_0004_brw.jpg");
  IpVec ipts;
  Kmeans km;
  ...
  for (int repeat = 0; repeat < 10; ++repeat)
  {
    ...
    IplImage *img = cvLoadImage("/Users/kylegoehner/payload/sift/images/ISSAC_0619_0005_brw.jpg");
    km.Run(&ipts, 5, true);
